        ...
        return (
          <div className={styles.contentArea}>
            <div className={styles.sectionCard}>
              ...
              <div style={{ display: 'flex', gap: '20px', flexDirection: 'column' }}>
                <div style={{ display: 'flex', gap: '16px', border: '1px solid #EBEBEB', borderRadius: '12px', padding: '16px', alignItems: 'center' }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <h4 style={{ margin: '0 0 4px 0', fontSize: '16px', color: 'var(--text-main)' }}>Luxury Heritage Villa</h4>
                    <p style={{ margin: '0 0 8px 0', fontSize: '13px', color: 'var(--text-secondary)' }}>Jaipur, Rajasthan</p>
                    <span style={{ fontSize: '12px', background: '#F0F0F0', padding: '4px 8px', borderRadius: '4px', color: 'var(--text-main)', fontWeight: 600 }}>Oct 15 - Oct 18, 2026</span>
                  </div>
            ...
            <div className={styles.sectionCard}>
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: '14px' }}>You have no past trips.</p>
            </div>
          </div>
        );
      case 'wishlists':
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: '20px' }}>
                ...
                <div style={{ border: '1px solid #EBEBEB', borderRadius: '12px', overflow: 'hidden' }}>
                  ...
                  <div style={{ padding: '16px' }}>
                    ...
                    <p style={{ margin: 0, fontSize: '13px', color: 'var(--text-secondary)' }}>3 saved properties</p>
                  </div>
                </div>
                ...
                <div style={{ border: '1px solid #EBEBEB', borderRadius: '12px', overflow: 'hidden' }}>
                  ...
                  <div style={{ padding: '16px' }}>
                    ...
                    <p style={{ margin: 0, fontSize: '13px', color: 'var(--text-secondary)' }}>5 saved properties</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={styles.sectionCard}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    <h4 style={{ margin: '0 0 4px 0', fontSize: '14px', color: 'var(--text-main)' }}>Email Notifications</h4>
                    <p style={{ margin: 0, fontSize: '12px', color: 'var(--text-secondary)' }}>Receive updates about bookings and offers.</p>
                  </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    <h4 style={{ margin: '0 0 4px 0', fontSize: '14px', color: 'var(--text-main)' }}>SMS Alerts</h4>
                    <p style={{ margin: 0, fontSize: '12px', color: 'var(--text-secondary)' }}>Receive text messages for check-in info.</p>
                  </div>
